...
<footer>
  ...
  <section class="footer-Content">
    <div class="container">
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12 wow fadeIn" data-wow-delay="0s">
          <div class="widget">
            <h3 class="block-title">About us</h3>
            <div class="textwidget">
              <p>We make travelling simple and comforting for our wonderful clients...</p>
              <p>We VisitSriLanka Management (Pvt) Ltd is one of Sri Lanka's momentous tour operators. Our reputation and greatness is earned everyday by providing the vital value and personal attention...</p>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="site-info pull-left">
            <p>All copyrights reserved @ 2016 - Designed by <a href="http://crystalcodesolutions.com/">CrystalCodeSolutions</a></p>
          </div>
